            ...
            <td>
                ...
                <table style="width: 100%; text-align: center; border-top: 1px solid rgba(0,0,0,0.1); border-bottom: 1px solid rgba(0,0,0,0.1); padding: 15px 0;" width="100%" cellspacing="0" cellpadding="0">
                    <thead style="font-size: 14px;">
                        ...
                        <th style="width: 800px; font-weight: 600; padding: 0 5px 15px;" width="800">Jumlah Barang</th>
                    ...
                    <tbody>
                        ...
                        <tr style="font-size: 13px;">
                            <td style="text-align: left; padding: 8px 5px 8px 15px;">
                                <span style="display: block; width: 270px;"><?php echo $key->nama_obat ?></span>
                            ...
                            <td style="width: 120px; padding: 8px 5px;" width="120"><?php echo $key->qty ?></td>
                            <td style="width: 115px; padding: 8px 5px;" width="115"><?php echo 'Rp'.number_format($key->harga_obat, 2,',','.'); ?></td>
...
?>
                        ...
                        <tr style="font-size: 13px; background-color: rgba(0,0,0,0.1);" bgcolor="#F1F1F1">
                            ...
                            <td style="width: 115px; font-weight: 600; text-align: right; padding: 8px 30px 8px 5px;" width="115"><?php echo 'Rp'.number_format($total, 2,',','.'); ?></td>
                        </tr>
                    </tbody>
                </table>
            </td>
